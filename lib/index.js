...
exports.default = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(getNetworkId, pathOverride, askForOnDeviceConfirmation, connTimeoutSeconds) {
    var ledger, LedgerWalletSubprovider;
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ledger = new _LedgerWallet2.default(getNetworkId, pathOverride, askForOnDeviceConfirmation, connTimeoutSeconds);
            _context.next = 3;
            return ledger.init();
